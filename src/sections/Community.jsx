            ...
            <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-[#CDD7C9] to-[#B6C2AE] flex items-center justify-center overflow-hidden">
              <div className="text-center p-8">
                <div className="flex justify-center -space-x-4 mb-4">
                  <div className="w-16 h-16 rounded-full bg-[#9EAB9A] border-2 border-white" />
                  <div className="w-16 h-16 rounded-full bg-[#7D8C7A] border-2 border-white" />
                  <div className="w-16 h-16 rounded-full bg-[#9EAB9A] border-2 border-white" />
                  <div className="w-16 h-16 rounded-full bg-[#7D8C7A] border-2 border-white" />
                </div>
            ...
            <div className="space-y-3 mb-8">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-center gap-3">
                  <div className="flex-shrink-0 w-5 h-5 rounded-full bg-[#7D8C7A] flex items-center justify-center">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <span className="text-[#3E4B3F]">{benefit}</span>
                </div>
              ))}
            </div>
