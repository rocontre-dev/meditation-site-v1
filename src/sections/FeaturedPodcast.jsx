          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-4xl mx-auto">
            {episodes.map((episode, index) => (
              <div key={index} className="text-left">
                ...
                <p className="text-[var(--zen-muted)] text-sm leading-relaxed mb-5">
                  {episode.description}
                </p>
                {episode.spotifyUrl && (
                  <a
                    ...
                    className="inline-flex items-center text-[var(--zen-moss)] text-sm font-medium hover:opacity-80 transition-opacity"
                  >
